...
n_pointxm = 2000;       % point x meter in measured obstacles generation
...
MC_int_N = 2000;        % Number of points for Montecarlo integration
...
lidar_n = 0.05;    % lidar radial noise standard deviation

% Initial P uncertainty
P_init = [25 0 0;0 25 0; 0 0 pi]; 
